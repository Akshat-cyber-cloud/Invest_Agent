      ...
      <div className="clario-frame">
        ...
        <nav style={{
          ...
          <ul className="nav-links-neobrutalist" style={{
            ...
            <li>
              <a href="https://github.com/Akshat-cyber-cloud/Invest_Agent" target="_blank" rel="noopener noreferrer" style={{ color: '#000', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '6px' }}>
                GitHub{" "}
